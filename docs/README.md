...
│   │   ├── workflow/
│   │   │   └── page.tsx           # Live workflow visualization
│   │   ├── health/
...
│   │       │   └── [id]/
│   │       │       └── route.ts   # GET: single incident
│   │       ├── escalate/
│   │       │   └── route.ts       # POST: trigger escalation
│   │       ├── health/
│   │       │   └── route.ts       # GET: service health
│   │       └── webhook/
│   │           └── slack/
│   │               └── route.ts   # POST: Slack webhook
...
│   │   │   ├── ai-pipeline.ts     # Gemini integration
│   │   │   └── escalation.ts      # Escalation actions
